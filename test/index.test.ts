...
describe("rehypeCustomEmoji", () => {
  ...
  it("[data-emoji] property", () => {
    ...
    const expected =
      '<h1>Hello</h1>\n<div>Hello <span data-emoji=""><img src="https://example.com/wave.gif" class="emoji"></span></div>';
    const htmlStr = parser(mrkStr, { emojis });
    expect(htmlStr).toEqual(expected);
  });
  ...
  it("custom className", () => {
    ...
    const expected =
      '<p>Hello, I\'m rehypeCustomEmoji <img src="https://example.com/wave.gif" class="customEmoji"></p>';
